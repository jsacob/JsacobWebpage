        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white shadow-sm rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 mb-6">
              ...
              <span className="font-semibold">Montreal, Canada</span>, I hope to
              move to <span className="font-semibold">Houston, Texas</span> in
              the near future to be part of the thriving tech community there
              and take the next steps in my career.
            </p>
